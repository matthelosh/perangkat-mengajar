       ...
       <h4 class="card-title">Nilai Ekstrakurikuler</h4>
          <div class="row">
            ...
            <div class="form-group col-sm-1">
              ...
              <select name="ekskul_id" id="ekskul_id" class="form-control selEkskul">
            ...
            <div class="form-group col-sm-2">
              ...
              <div class="btn-group">
                <button class="btn btn-primary" id="btnFormNilaiEkskul">
                  <i class="mdi mdi-magnify"></i>
                  Tampilkan
                </button>
                <button class="btn btn-success" id="btnFormatNilaiEkskul">
  ...
  <div class="card-body">
    <div class="row">
      <div class="col-sm-8">
        ...
        <hr>
        <form action="" class="form" id="formNilaiEkstra" method="POST">
          @csrf()
          <div class="table-responsive">
            <table id="table-form-nilai-ekstra" class="table table-bordered table-sm">
              <thead>
                <tr>
